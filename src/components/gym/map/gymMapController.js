...
var GymMapController = BaseController.extend({
    ...
    initialize:function($scope, Notifications,$state, GymModel){
    ...
    defineScope:function(){
        ...
        this.notifications.notify(models.events.BRAND_CHANGE, gymName);
    },
...
GymMapController.$inject = ['$scope','Notifications','$state', 'GymModel'];
